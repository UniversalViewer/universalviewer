...
// NOTE: the JQuery interface augmentation for these plugins lives in
// src/globals.d.ts — an interface declared inside this module would be
// module-local and invisible to the rest of the app.
