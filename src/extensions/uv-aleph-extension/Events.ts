export class Events {
  ...
  static BOUNDING_BOX_ENABLED_CHANGED: string =
    Events.namespace + "boundingBoxEnabledChanged";
  static CLEAR_GRAPH: string = Events.namespace + "clearGraph";
  static CONTROLS_TYPE_CHANGED: string =
    Events.namespace + "controlsTypeChanged";
  ...
  static GRAPH_ENABLED_CHANGED: string =
    Events.namespace + "graphEnabledChangedChanged";
  ...
  static SLICES_BRIGHTNESS_CHANGED: string =
    Events.namespace + "slicesBrightnessChanged";
  static SLICES_CONTRAST_CHANGED: string =
    Events.namespace + "slicesWindowWidthChanged";
  ...
  static VOLUME_BRIGHTNESS_CHANGED: string =
    Events.namespace + "volumeBrightnessChanged";
  static VOLUME_CONTRAST_CHANGED: string =
    Events.namespace + "volumeContrastChanged";
}
