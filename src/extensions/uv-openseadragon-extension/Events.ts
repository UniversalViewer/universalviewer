export class Events {
    ...
    static OPENSEADRAGON_ANIMATION_FINISH: string               = Events.namespace + 'animationFinish';
    static OPENSEADRAGON_ANIMATION_START: string                = Events.namespace + 'animationStart';
