    ...
    setDockedPosition(): void {
        ...
        if (this.$triggerButton) {
            ...
            if (!this.extension.isDesktopMetric()) {
                normalisedPos = Math.normalise((<JQuery>this.$triggerButton).offset().left, 0, this.extension.width());
            } else {
                normalisedPos = Math.normalise((<JQuery>this.$triggerButton).position().left, 0, this.extension.width());
            }
