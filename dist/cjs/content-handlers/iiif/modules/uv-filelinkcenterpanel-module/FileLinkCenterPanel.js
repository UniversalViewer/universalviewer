...
exports.FileLinkCenterPanel = void 0;
var $ = window.$;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (i = 0; i < annotations.length; i++) {
                            ...
                            label = manifesto_js_1.LanguageMap.getValue(annotationBody.getLabel());
                            if (label) {
                                $label.text((0, Utils_1.sanitize)(label));
                            }
                            ...
                            if (description) {
                                $description.text((0, Utils_1.sanitize)(description));
                                if (id) {
                        ...
                        this.extensionHost.publish(Events_1.Events.EXTERNAL_RESOURCE_OPENED);
                        this.extensionHost.publish(Events_1.Events.LOAD);
                        return [2 /*return*/];
                }
            });
        });
